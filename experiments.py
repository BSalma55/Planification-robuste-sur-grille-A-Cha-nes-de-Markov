...
# ============================================================
# Classes locales autonomes (pas d'import externe)
# ============================================================
...
class AStar:
    def __init__(self, grid, heuristic='manhattan'):
        self.grid = grid
        self.h = (grid.manhattan_distance
                  if heuristic == 'manhattan'
                  else grid.zero_heuristic)
...
class MarkovChain:
    ...
    def absorption_analysis(self):
        if not self.absorbing_indices:
            return None
        trans_idx = [i for i in range(self.n)
        ...
        try:
            ...
            return {'B': B, 't': t, 'N': N,
                    'trans_indices': trans_idx, 'abs_indices': abs_idx}
        except Exception:
            return None
...
def figure_1():
    ...
    plt.tight_layout()
    plt.savefig('Figure1_Visualisation_chemins_planifies.png',
...
def figure_2():
    ...
    plt.tight_layout()
    plt.savefig('Figure2_Comparaison_UCS_Greedy_A.png',
                dpi=150, bbox_inches='tight')
    plt.show()
...
def figure_3():
    ...
    fig.suptitle(
        ...
        fontsize=14, fontweight='bold')
    plt.savefig('Figure3_Impact_incertitude_epsilon.png',
                dpi=150, bbox_inches='tight')
    plt.show()
...
# ============================================================
# FIGURE 4 : Comparaison heuristiques h=0 vs Manhattan
# ============================================================
...
def figure_4():
    ...
    plt.tight_layout()
    plt.savefig('Figure4_Comparaison_heuristiques.png',
                dpi=150, bbox_inches='tight')
    plt.show()
...
if __name__ == "__main__":
    ...
    for i, f in enumerate([
        "Figure1_Visualisation_chemins_planifies.png",
        "Figure2_Comparaison_UCS_Greedy_A.png",
        "Figure3_Impact_incertitude_epsilon.png",
        "Figure4_Comparaison_heuristiques.png",
        "Figure5_Weighted_A.png",
    ], 1):
        print(f"  {i}. {f}")
    print("\n" + "="*80 + "\n")